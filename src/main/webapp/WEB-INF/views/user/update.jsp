                    ...
                    <div class="panel panel-primary">
					           	<div class="panel-heading">
					                        ...
					                        <div class="panel-body">
								  				<form action="/usersService/users?update=${client.id}" method="post">
										    				<div class="form-group">
					                                            <label><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Nom</font></font></label>                                      
					                                            <input name="nom" value="${client.nom}" class="form-control" placeholder="Nom" required="required" />
					                                        </div>
					                                        <div class="form-group">
					                                            <label><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Prénom</font></font></label>
					                                            <input name="prenom" value="${client.prenom}" class="form-control" placeholder="Prenom" required="required" />
					                                        </div>
					                                        <div class="form-group">
					                                            <label><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Adresse</font></font></label>
					                                            <input name="adresse" value="${client.adresse}" class="form-control" placeholder="Adresse" required="required" />
					                                        </div>
					                                        <div class="form-group">
					                                            <label><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Mail</font></font></label>
					                                            <input name="mail" value="${client.mail}" class="form-control" placeholder="Mail" required="required" />
					                                        </div>
					                                        <div class="form-group">
					                                            <label><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Téléphone</font></font></label>
					                                            <input name="phone" value="${client.phone}" class="form-control" placeholder="Telephone" required="required" />
					                                        </div>
